...
function updateImage() {
    ...
    // Check if the entered value is between 1 and 15
    if (value >= 1 && value <= 15) {
        ...
        errorMessage.textContent = 'Please enter a valid number between 1 and 15.';
    }
}

// Initial call to populate categories based on the default book selection
updateCategories(currentBook);
